...
# TODO: Remove pymel where possible
...
class NamingWidget(QtWidgets.QFrame):
    def __init__(self):
        ...
        # Label Splitter
        additions_splitter = Splitter('Prefix & Suffix')
        ...
        additions_widget.layout().addLayout(SplitterLayout())
        ...
        # Label Splitter
        cleanup_splitter = Splitter('Cleanup')
